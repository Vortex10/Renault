...
$(document).ready(function () {
  ...
  $('.navbar-fixed-top').addClass('top-nav-collapse');
    // Click links menu
    $('.navbar-fixed-top a[href^="#anch"]').on('click', function () {
      $('.navbar-fixed-top').addClass('top-nav-collapse');
      $('a[href^="#anch-slideshow"]').on('hidden.bs.tab', function () {
        $('.navbar-brand').attr('href', '#anch-slideshow');
      });
    });

    $('.navbar-fixed-top a[href^="#anch-slideshow"]').on('click', function () {
      $('.navbar-fixed-top').removeClass('top-nav-collapse');
      $('.navbar-brand').attr('href', '');
      $('a[href^="#anch-slideshow"]').on('shown.bs.tab', function () {
        $('.navbar-brand').attr('href', '');
      });
    });
    ...
    // Click any link on site
    $('section a[href^="#anch"],.slideshow.carousel-indicators>li>a').on('click', function () {
      var liAnch = $(this).attr('href');
      liAnch = liAnch.replace('#', '');
      $('.navbar-fixed-top').addClass('top-nav-collapse');
      $('.navbar-fixed-top .navbar-nav>li').removeClass('active');
      $('.navbar-fixed-top .navbar-nav>li.' + liAnch + '').addClass('active');
      $('.navbar-brand').attr('href', '#anch-slideshow');
    });
  });
  ...
  $(function () {
    ...
    $('a[href="#anch-features"]').on('shown.bs.tab', function () {
      setTimeout(function () {
        c4.start();
      }, 600);
    });
  ...
  $(function () {
    ...
    if ((windowWidth < 768) && (windowHeight > 479) && ($('section.overview').length)) {
      $('a[href="#anch-overview"]').on('shown.bs.tab', function () {
  ...
  $(function () {
    ...
    if ((windowWidth > 767) && ($('section.gallery').length)) {
      $('a[href="#anch-gallery"]').on('shown.bs.tab', function () {
  ...
  /*----------------------------------------------------------------------------------------------
   ...
   ----------------------------------------------------------------------------------------------*/
  $(function () {
    $('a[href="#anch-testimonials"]').on('shown.bs.tab', function () {
  ...
  $(function () {
    ...
    if ((windowWidth < 768) && ($('section.prices').length)) {
      $('a[href="#anch-prices"]').on('shown.bs.tab', function () {
  ...
  $(function () {
    ...
    if ((windowWidth < 768) && ($('section.team').length)) {
      $('a[href="#anch-team"]').on('shown.bs.tab', function () {
  ...
  $(function () {
    ...
    if ((windowWidth < 768) && ($('section.contact').length)) {
      $('a[href="#anch-contact"]').on('shown.bs.tab', function () {
